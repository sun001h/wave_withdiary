...
<body>
	<div id="content">
		...
		<section class="carousel">
			<div class="reel">
				<c:forEach var="f_board" items="${friendBoard}">
				<article>
					<div>
							...
							<header>
								<h3 class="etx">
									<a href="${contextPath}/board/view?d_articlenumber=${f_board.d_articlenumber}">${f_board.title}</a>
								</h3>
							</header>
							<div class="etc">${f_board.content}<br><br></div>
							<p style="text-align: right;">
								<fmt:formatDate value="${f_board.dateCreated}" pattern="yyyy-MM-dd" />
							</p>
